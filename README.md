...
3. Установить все зависимости:
   ...
   ```
4. Скачать модель эмбеддингов по ссылке и поместить ее в директорию: `/taa_model/emb/`
5. Скачать размеченные данные для обучения по ссылке и поместить их в директорию: `/taa_model/data/`
6. Подготововить данные используя jupyter notebook
7. Обучить модель использюя jupyter notebook
8. При желание можете эксперементировать с моделями, с обработкой данных. Just as you wish.
